...
<summary><code>identifier</code> — Parse an identifier — starts with letter or underscore, no leading digit, no hyphen.</summary>
...
<details id="integer">
<summary><code>integer</code> — Parse a signed integer.</summary>
...
<details id="literal">
<summary><code>literal</code> — Parse a word-like value including hyphens.</summary>
...
<details id="number">
<summary><code>number</code> — Parse an integer or float.</summary>
...
<details id="space">
<summary><code>space</code> — Parse a single space character.</summary>
...
<details id="spaces">
<summary><code>spaces</code> — Parse one or more space characters.</summary>
...
<details id="concat">
<summary><code>concat</code> — Join string array parser result into a single string.</summary>
...
<details id="flag">
<summary><code>flag</code> — Return true if parser succeeds, false otherwise. Always succeeds without consuming input on failure.</summary>
...
<details id="node">
<summary><code>node</code> — Create a node from parser fields.</summary>
...
<details id="pure">
<summary><code>pure</code> — Always return a value without consuming input.</summary>
...
<details id="value">
<summary><code>value</code> — Replace parsed value with a constant.</summary>
...
<details id="when">
<summary><code>when</code> — Branch on a boolean parser result.</summary>
